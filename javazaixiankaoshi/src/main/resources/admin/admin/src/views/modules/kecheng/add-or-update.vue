        ...
        <el-form
            ...
            <input id="laoshiId" name="laoshiId" type="hidden">
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.kechengFile" label="课程文件" prop="kechengFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="ruleForm.kechengFile"  >课程文件下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="所属科目" prop="kemuTypes">
                        <el-select v-model="ruleForm.kemuTypes" :disabled="ro.kemuTypes" placeholder="请选择所属科目">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="所属科目" prop="kemuValue">
